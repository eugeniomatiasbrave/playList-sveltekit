...
<div class="flex flex-col w-full h-full space-y-12">
	<div class="w-full">
		<h3 class="text-2xl font-medium">Cambiar Email</h3>
		<div class="divider" />
		<Modal label="change-email" checked={emailModalOpen}>
			<span slot="trigger" class="btn btn-primary">Cambiar Email</span>
			<h3 slot="heading">Cambiar tu Email</h3>
			<form action="?/updateEmail" method="POST" class="space-y-2" use:enhance={submitUpdateEmail}>
				...
				<button type="submit" class="btn btn-primary w-full" disabled={loading}
					>Cambiar mi email</button
				>
			</form>
		</Modal>
	</div>
	<div class="w-full">
		<h3 class="text-2xl font-medium">Cambie el nombre de usuario</h3>
		...
		<Modal label="change-username" checked={usernameModalOpen}>
			<span slot="trigger" class="btn btn-primary">Cambio de usuario</span>
			<h3 slot="heading">Cambia tu usuario</h3>
			<form
